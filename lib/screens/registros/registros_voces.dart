...
class RegistroVoces extends StatelessWidget {
  const RegistroVoces({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Registros de Voces"),
      ),
      body: PreferencesApp.isPcApp == true
          ? const RegistroVocesPC()
          : const RegistroVocesAndroid(),
    );
  }
}

class RegistroVocesAndroid extends StatefulWidget {
  const RegistroVocesAndroid({
    Key? key,
  }) : super(key: key);

  @override
  State<RegistroVocesAndroid> createState() => _RegistroVocesAndroidState();
}

class _RegistroVocesAndroidState extends State<RegistroVocesAndroid> {
  @override
  Widget build(BuildContext context) {
...
class RegistroVocesPC extends StatefulWidget {
  const RegistroVocesPC({
    Key? key,
  }) : super(key: key);

  @override
  State<RegistroVocesPC> createState() => RegistroVocesPCState();
}

class RegistroVocesPCState extends State<RegistroVocesPC> {
