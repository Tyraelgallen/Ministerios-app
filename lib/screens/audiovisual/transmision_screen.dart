...
pcfirebase.CollectionReference transmisionCollectionPC =
    pcfirebase.Firestore.instance.collection('registro_transmision');

class TransmisionScreen extends StatefulWidget {
  const TransmisionScreen({Key? key}) : super(key: key);
                    ...
                    TextButton(
                        onPressed: () async {
                          ...
                          if (PreferencesApp.isPcApp == false) {
                            ...
                            await saveWindows3(
                                image1, image2, image3, "Transmisión");
                          }

                          ResetPrefsTransmision();
                          if (PreferencesApp.isPcApp == false) {
    ...
    return Column(
      children: [
        ...
        CheckboxListTile(
          ...
          value: PreferencesTransmision.field0,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field0 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Encender Luces Plataforma"),
          value: PreferencesTransmision.field1,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field1 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Encender Filmadora"),
          value: PreferencesTransmision.field10,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field10 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Encender PC de Proyección y Transmisión"),
          value: PreferencesTransmision.field2,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field2 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Encender Ventilador/Caloventor"),
          value: PreferencesTransmision.field3,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field3 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Abrir Programas"),
          value: PreferencesTransmision.field11,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field11 = val!;
            });
          },
        ),
      ],
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        CheckboxListTile(
          title:
              const Text("Iniciar Transmision en Face p/pruebas: Machin Lie "),
          value: PreferencesTransmision.field12,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field12 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Probar Auriculares y Parlantes"),
          value: PreferencesTransmision.field13,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field13 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Chequear audio en Face p/pruebas"),
          value: PreferencesTransmision.field4,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field4 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text(
              "Notificar a sonido si hay fallas en la calidad del audio"),
          value: PreferencesTransmision.field5,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field5 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text(
              "Poner Título a la Transmisión y Cambiar miniatura de Youtube"),
          value: PreferencesTransmision.field17,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field17 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text(
              "Iniciar Transmisión en Facebook Leonardo Espinosa y Youtube Iglesia Pasión por la Vida"),
          value: PreferencesTransmision.field15,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field15 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Enviar mensajes de Bienvenida en Comentarios"),
          value: PreferencesTransmision.field16,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field16 = val!;
            });
          },
        ),
        const SugerenciasFieldInput1(),
      ],
    );
  }
}
    ...
    return Column(
      children: [
        CheckboxListTile(
          ...
          value: PreferencesTransmision.field6,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field6 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Apagar PC y monitores de Transmisión"),
          value: PreferencesTransmision.field7,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field7 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Apagar Ventilador/Caloventor, y luz de cuarto"),
          value: PreferencesTransmision.field8,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field8 = val!;
            });
          },
        ),
        CheckboxListTile(
          title: const Text("Apagar Termicas y luces de la plataforma"),
          value: PreferencesTransmision.field9,
          onChanged: (val) {
            setState(() {
              PreferencesTransmision.field9 = val!;
            });
          },
        ),
...
_addRegistro() async {
  ...
  await transmisionCollectionPC.add(json);
}
